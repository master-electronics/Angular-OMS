    ...
    <form nz-form [formGroup]="filterForm">
      <div class="grid grid-cols-10 gap-3">
        ...
        <nz-form-item class="col-span-1">
          <button
            class="mr-2 h-10 rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200"
            (click)="excel.emit()"
          >
            Save
          </button>
