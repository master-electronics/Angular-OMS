...
export type FindPartQuery = { __typename?: 'Query', findPart?: { __typename?: 'Product', _id: number, PartNumber: string, ProductCodeID: number, ProductTier?: string | null } | null };
...
export type InsertReceiptLineMutationVariables = Types.Exact<{
  ...
  rhos?: Types.InputMaybe<Types.Scalars['Boolean']>;
}>;
...
export const InsertReceiptLineDocument = gql`
    mutation insertReceiptLine($receiptHID: Int!, $productID: Int!, $expectedQuantity: Int!, $dateCode: String, $countryID: Int, $rhos: Boolean) {
  insertReceiptLine(
...
export const UpdateReceiptLineDocument = gql`
    mutation updateReceiptLine($receiptLID: Int!, $productID: Int!, $expectedQuantity: Int!, $dateCode: String, $countryID: Int, $rhos: Boolean) {
  updateReceiptLine(
