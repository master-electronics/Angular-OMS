...
export type FindBindedPrinterQuery = { __typename?: 'Query', findPrinters?: Array<{ __typename?: 'Printer', Name: string, Orientation?: string | null, DPI?: number | null } | null> | null };

export type FindInventoryByUserQueryVariables = Types.Exact<{
  username?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type FindInventoryByUserQuery = { __typename?: 'Query', findInventoryByUser?: Array<{ __typename?: 'Inventory', InventoryTrackingNumber: string } | null> | null };

export type CreateItnMutationVariables = Types.Exact<{
  LocationCode: Types.Scalars['String'];
}>;


export type CreateItnMutation = { __typename?: 'Mutation', createITN: string };
...
export type Insert_EventLogsMutationVariables = Types.Exact<{
  logs: Array<Types.InputMaybe<Types.InsertEventLog>> | Types.InputMaybe<Types.InsertEventLog>;
}>;


export type Insert_EventLogsMutation = { __typename?: 'Mutation', insertEventLogs: boolean };

export type Create_EventLogsMutationVariables = Types.Exact<{
  oldLogs: Array<Types.InputMaybe<Types.InsertUserEventLog>> | Types.InputMaybe<Types.InsertUserEventLog>;
  eventLogs: Array<Types.InputMaybe<Types.InsertEventLog>> | Types.InputMaybe<Types.InsertEventLog>;
}>;


export type Create_EventLogsMutation = { __typename?: 'Mutation', insertEventLogs: boolean, insertUserEventLogs?: Array<{ __typename?: 'UserEventLog', _id: number } | null> | null };
...
export type FindorCreateUserContainerMutationVariables = Types.Exact<{
...
export type FindorCreateUserContainerMutation = { __typename?: 'Mutation', findOrCreateUserContainer?: { __typename?: 'Container', _id: number } | null };

export type ChangeItnListForMerpMutationVariables = Types.Exact<{
  ITNList: Array<Types.InputMaybe<Types.InventoryUpdateForMerp>> | Types.InputMaybe<Types.InventoryUpdateForMerp>;
}>;


export type ChangeItnListForMerpMutation = { __typename?: 'Mutation', changeItnListForMerp?: boolean | null };
...
export const FindBindedPrinterDocument = gql`
  ...
  export class FindBindedPrinterGQL extends Apollo.Query<FindBindedPrinterQuery, FindBindedPrinterQueryVariables> {
    document = FindBindedPrinterDocument;
    client = 'wmsNodejs';
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const FindInventoryByUserDocument = gql`
  ...
  export class FindInventoryByUserGQL extends Apollo.Query<FindInventoryByUserQuery, FindInventoryByUserQueryVariables> {
    document = FindInventoryByUserDocument;
    client = 'wmsNodejs';
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
...
export const CreateItnDocument = gql`
  ...
  export class CreateItnGQL extends Apollo.Mutation<CreateItnMutation, CreateItnMutationVariables> {
...
export const Insert_EventLogsDocument = gql`
  ...
  export class Insert_EventLogsGQL extends Apollo.Mutation<Insert_EventLogsMutation, Insert_EventLogsMutationVariables> {
...
export const Create_EventLogsDocument = gql`
  ...
  export class Create_EventLogsGQL extends Apollo.Mutation<Create_EventLogsMutation, Create_EventLogsMutationVariables> {
    document = Create_EventLogsDocument;
    client = 'wmsNodejs';
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
...
export const FindorCreateUserContainerDocument = gql`
  ...
  export class FindorCreateUserContainerGQL extends Apollo.Mutation<FindorCreateUserContainerMutation, FindorCreateUserContainerMutationVariables> {
...
export const ChangeItnListForMerpDocument = gql`
  ...
  export class ChangeItnListForMerpGQL extends Apollo.Mutation<ChangeItnListForMerpMutation, ChangeItnListForMerpMutationVariables> {
