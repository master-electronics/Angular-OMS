...
export type FetchOmsConfigValueQuery = {
  __typename?: 'Query';
  fetchConfigValue?: { __typename?: 'OMSCONFIG'; Value?: string | null } | null;
};
...
export class FetchOmsConfigValueGQL extends Apollo.Query<
  FetchOmsConfigValueQuery,
  FetchOmsConfigValueQueryVariables
> {
