...
export type UpdateAfterAgOutMutation = { __typename?: 'Mutation', updateOrderLineDetail?: Array<number | null> | null, updateOrder?: Array<number | null> | null, changeItnListForMerp?: boolean | null, updateMerpOrderStatus: { __typename?: 'Response', success: boolean, message?: string | null }, updateMerpWMSLog: { __typename?: 'Response', success: boolean, message?: string | null } };
...
export type UpdateLocationAfterAgInMutationVariables = Types.Exact<{
  ContainerID: Types.Scalars['Int'];
  Container: Types.UpdateContainer;
}>;


export type UpdateLocationAfterAgInMutation = { __typename?: 'Mutation', updateContainer?: Array<number | null> | null };
...
export const UpdateAfterAgOutDocument = gql`
    mutation updateAfterAgOut($OrderID: Int!, $OrderLineDetail: updateOrderLineDetail!, $DistributionCenter: String!, $OrderNumber: String!, $NOSINumber: String!, $MerpStatus: String!, $UserOrStatus: String!, $FileKeyList: [String!]!, $ActionType: String!, $Action: String!, $ITNList: [InventoryUpdateForMerp]!) {
...
export const UpdateLocationAfterAgInDocument = gql`
  ...
  export class UpdateLocationAfterAgInGQL extends Apollo.Mutation<UpdateLocationAfterAgInMutation, UpdateLocationAfterAgInMutationVariables> {
    document = UpdateLocationAfterAgInDocument;
    client = 'wmsNodejs';
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
