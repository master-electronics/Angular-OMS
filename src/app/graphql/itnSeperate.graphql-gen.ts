...
export type VerifyItnForSeperateQueryVariables = Types.Exact<{
  ITN: Types.Scalars['String'];
  DC: Types.Scalars['String'];
}>;

export type VerifyItnForSeperateQuery = {
  __typename?: 'Query';
  findInventory?: {
    __typename?: 'Inventory';
    _id: number;
...
export class VerifyItnForSeperateGQL extends Apollo.Query<
  VerifyItnForSeperateQuery,
