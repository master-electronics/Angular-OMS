...
export type VerifyItnForSeparateQuery = { __typename?: 'Query', findInventory?: { __typename?: 'Inventory', _id: number, QuantityOnHand: number, ORDERLINEDETAILs?: Array<{ __typename?: 'OrderLineDetail', StatusID: number } | null> | null, Product: { __typename?: 'Product', PartNumber: string, ProductCode: { __typename?: 'ProductCode', ProductCodeNumber: string } } } | null };

export type ItnSplitAndPrintLabelsMutationVariables = Types.Exact<{
  QuantityList: Array<Types.InputMaybe<Types.Scalars['Float']>> | Types.InputMaybe<Types.Scalars['Float']>;
...
export type ItnSplitAndPrintLabelsMutation = { __typename?: 'Mutation', ITNSplitAndPrintLabels: Array<string | null> };
...
export const VerifyItnForSeparateDocument = gql`
  ...
  export class VerifyItnForSeparateGQL extends Apollo.Query<VerifyItnForSeparateQuery, VerifyItnForSeparateQueryVariables> {
...
export const ItnSplitAndPrintLabelsDocument = gql`
  ...
  export class ItnSplitAndPrintLabelsGQL extends Apollo.Mutation<ItnSplitAndPrintLabelsMutation, ItnSplitAndPrintLabelsMutationVariables> {
