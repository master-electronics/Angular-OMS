...
export type FetchAuditTypesQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type FetchAuditTypesQuery = {
  __typename?: 'Query';
  fetchAuditTypes?: Array<{
    __typename?: 'AUDITTYPE';
    _id?: number | null;
    Type?: string | null;
    Order?: number | null;
...
export type FetchSystemAuditListQueryVariables = Types.Exact<{
  includedDeactivated?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;

export type FetchSystemAuditListQuery = {
  __typename?: 'Query';
  fetchSystemAudits?: Array<{
    __typename?: 'IMTRIGGER';
    _id?: number | null;
    Name?: string | null;
    ...
    Active?: boolean | null;
    IMTrigger_AuditTypes?: Array<{
      __typename?: 'IMTrigger_AuditType';
      _id?: number | null;
      IMTriggerID?: number | null;
      IMAuditTypeID?: number | null;
      IMAuditType?: {
        __typename?: 'AUDITTYPE';
        _id?: number | null;
        Type?: string | null;
...
export type VerifyAuditLocationQuery = {
  __typename?: 'Query';
...
export type FindProductCodeQuery = {
  __typename?: 'Query';
  findProductCode?: {
    __typename?: 'ProductCode';
    _id: number;
...
export type FindImProductQueryVariables = Types.Exact<{
  product?: Types.InputMaybe<Types.SearchProduct>;
}>;

export type FindImProductQuery = {
  __typename?: 'Query';
  findProduct?: {
    __typename?: 'Product';
    _id?: number | null;
...
export type FindImInventoryQueryVariables = Types.Exact<{
  inventory: Types.SearchInventory;
}>;

export type FindImInventoryQuery = {
  __typename?: 'Query';
  findInventory?: {
    __typename?: 'Inventory';
    _id: number;
...
export type FindImInventoriesQueryVariables = Types.Exact<{
  ...
  barcodeStart?: Types.InputMaybe<Types.Scalars['String']['input']>;
  barcodeEnd?: Types.InputMaybe<Types.Scalars['String']['input']>;
  prc?: Types.InputMaybe<Types.Scalars['String']['input']>;
  partNumber?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;

export type FindImInventoriesQuery = {
  __typename?: 'Query';
  findIMInventories?: Array<{
    __typename?: 'AUDITINVENTORY';
    _id?: number | null;
...
export type FindImprcInventoriesQueryVariables = Types.Exact<{
  prc?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;

export type FindImprcInventoriesQuery = {
  __typename?: 'Query';
  findIMPRCInventories?: Array<{
    __typename?: 'Inventory';
    _id: number;
  } | null> | null;
};

export type FindImprcPartNumberInventoriesQueryVariables = Types.Exact<{
  prc?: Types.InputMaybe<Types.Scalars['String']['input']>;
  partNumber?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;

export type FindImprcPartNumberInventoriesQuery = {
  __typename?: 'Query';
  findIMPRCPartNumberInventories?: Array<{
    __typename?: 'Inventory';
    _id: number;
  } | null> | null;
};

export type ValidateFilterQueryVariables = Types.Exact<{
  itn?: Types.InputMaybe<Types.Scalars['String']['input']>;
  locationStart?: Types.InputMaybe<Types.Scalars['String']['input']>;
  locationEnd?: Types.InputMaybe<Types.Scalars['String']['input']>;
  prc?: Types.InputMaybe<Types.Scalars['String']['input']>;
  partNumber?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;

export type ValidateFilterQuery = {
  __typename?: 'Query';
  validateFilter?: boolean | null;
};

export type FindNextAuditQueryVariables = Types.Exact<{
  userID?: Types.InputMaybe<Types.Scalars['Int']['input']>;
  barcode?: Types.InputMaybe<Types.Scalars['String']['input']>;
  distributionCenter?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;

export type FindNextAuditQuery = {
  __typename?: 'Query';
  findNextAudit?: Array<{
    __typename?: 'AUDIT';
    _id?: number | null;
...
export type FetchGlobalMessagesQueryVariables = Types.Exact<{
  inventoryId?: Types.InputMaybe<Types.Scalars['Int']['input']>;
}>;
...
export type GetSearchLocationQuery = {
  __typename?: 'Query';
  getSearchLocation?: Array<{
    __typename?: 'SEARCHLOCATION';
    _id?: number | null;
    Barcode?: string | null;
  } | null> | null;
...
export type ValidateAssignmentQueryVariables = Types.Exact<{
  auditID?: Types.InputMaybe<Types.Scalars['Int']['input']>;
  userID?: Types.InputMaybe<Types.Scalars['Int']['input']>;
}>;

export type ValidateAssignmentQuery = {
  __typename?: 'Query';
...
export type FetchPreviousLocationQueryVariables = Types.Exact<{
  ...
  binlocation: Types.Scalars['String']['input'];
}>;
...
export type UpdateLastUpdatedMutationVariables = Types.Exact<{
  ...
  lastUpdated?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;

export type UpdateLastUpdatedMutation = {
  __typename?: 'Mutation';
  updateLastUpdated?: { __typename?: 'AUDIT'; _id?: number | null } | null;
};

export type InsertAuditsMutationVariables = Types.Exact<{
  audits?: Types.InputMaybe<
    | Array<Types.InputMaybe<Types.InputAudit>>
    | Types.InputMaybe<Types.InputAudit>
  >;
}>;

export type InsertAuditsMutation = {
  __typename?: 'Mutation';
  insertAudits?: Array<{
    __typename?: 'AUDIT';
    _id?: number | null;
...
export type InsertSuspectMutationVariables = Types.Exact<{
  suspect?: Types.InputMaybe<
    | Array<Types.InputMaybe<Types.InputSuspect>>
    | Types.InputMaybe<Types.InputSuspect>
  >;
}>;

export type InsertSuspectMutation = {
  __typename?: 'Mutation';
  insertSuspect?: { __typename?: 'AUDIT'; _id?: number | null } | null;
};

export type InventoryUpdateMutationVariables = Types.Exact<{
  user: Types.Scalars['String']['input'];
  itn: Types.Scalars['String']['input'];
  quantity?: Types.InputMaybe<Types.Scalars['String']['input']>;
  dateCode?: Types.InputMaybe<Types.Scalars['String']['input']>;
  country?: Types.InputMaybe<Types.Scalars['String']['input']>;
  rohs?: Types.InputMaybe<Types.Scalars['String']['input']>;
  reason: Types.Scalars['String']['input'];
  suspect?: Types.InputMaybe<Types.Scalars['String']['input']>;
  binlocation?: Types.InputMaybe<Types.Scalars['String']['input']>;
  verificationState?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;
...
export type ReplanPickMutationVariables = Types.Exact<{
  ...
  orderLineNumber?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;
...
export type RecreateItnMutationVariables = Types.Exact<{
  user: Types.Scalars['String']['input'];
  itn: Types.Scalars['String']['input'];
  warehouse: Types.Scalars['String']['input'];
  binlocation: Types.Scalars['String']['input'];
...
export type CloseAuditMutation = {
  __typename?: 'Mutation';
  closeAudit?: { __typename?: 'AUDIT'; _id?: number | null } | null;
};
...
export type CloseAuditsMutation = {
  __typename?: 'Mutation';
  closeAudits?: Array<{
    __typename?: 'AUDIT';
    _id?: number | null;
...
export type ClearTimeoutAuditsMutationVariables = Types.Exact<{
  seconds?: Types.InputMaybe<Types.Scalars['Int']['input']>;
}>;

export type ClearTimeoutAuditsMutation = {
  __typename?: 'Mutation';
  clearTimeoutAudits?: { __typename?: 'AUDIT'; _id?: number | null } | null;
};

export type UpdateSystemTriggerMutationVariables = Types.Exact<{
  triggerId?: Types.InputMaybe<Types.Scalars['Int']['input']>;
  trigger?: Types.InputMaybe<Types.ImTrigger>;
  auditTypes?: Types.InputMaybe<
    | Array<Types.InputMaybe<Types.Scalars['Int']['input']>>
    | Types.InputMaybe<Types.Scalars['Int']['input']>
  >;
}>;

export type UpdateSystemTriggerMutation = {
  __typename?: 'Mutation';
  updateSystemTrigger?: {
    __typename?: 'IMTRIGGER';
    _id?: number | null;
...
export type InsertSystemTriggerMutation = {
  __typename?: 'Mutation';
  insertSystemTrigger?: {
    __typename?: 'IMTRIGGER';
    _id?: number | null;
...
export class FetchAuditTypesGQL extends Apollo.Query<
  FetchAuditTypesQuery,
  FetchAuditTypesQueryVariables
> {
...
export class FetchSystemAuditListGQL extends Apollo.Query<
  FetchSystemAuditListQuery,
  FetchSystemAuditListQueryVariables
> {
...
export const VerifyAuditLocationDocument = gql`
...
export class VerifyAuditLocationGQL extends Apollo.Query<
  VerifyAuditLocationQuery,
  VerifyAuditLocationQueryVariables
> {
  document = VerifyAuditLocationDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
...
export class FindProductCodeGQL extends Apollo.Query<
  FindProductCodeQuery,
  FindProductCodeQueryVariables
> {
  document = FindProductCodeDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const FindImProductDocument = gql`
...
export class FindImProductGQL extends Apollo.Query<
  FindImProductQuery,
  FindImProductQueryVariables
> {
  document = FindImProductDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const FindImInventoryDocument = gql`
...
export class FindImInventoryGQL extends Apollo.Query<
  FindImInventoryQuery,
...
export const FindImInventoriesDocument = gql`
...
export class FindImInventoriesGQL extends Apollo.Query<
  FindImInventoriesQuery,
  FindImInventoriesQueryVariables
> {
  document = FindImInventoriesDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const FindImprcInventoriesDocument = gql`
...
export class FindImprcInventoriesGQL extends Apollo.Query<
  FindImprcInventoriesQuery,
  FindImprcInventoriesQueryVariables
> {
  document = FindImprcInventoriesDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const FindImprcPartNumberInventoriesDocument = gql`
...
export class FindImprcPartNumberInventoriesGQL extends Apollo.Query<
  FindImprcPartNumberInventoriesQuery,
  FindImprcPartNumberInventoriesQueryVariables
> {
  document = FindImprcPartNumberInventoriesDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const ValidateFilterDocument = gql`
...
export class ValidateFilterGQL extends Apollo.Query<
  ValidateFilterQuery,
  ValidateFilterQueryVariables
> {
  document = ValidateFilterDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
...
export class FindNextAuditGQL extends Apollo.Query<
  FindNextAuditQuery,
  FindNextAuditQueryVariables
> {
  document = FindNextAuditDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
...
export class GetNextSubAuditGQL extends Apollo.Query<
  GetNextSubAuditQuery,
  GetNextSubAuditQueryVariables
> {
...
export class GetSearchLocationGQL extends Apollo.Query<
...
export class GetSearchLocationsGQL extends Apollo.Query<
...
export class ValidateAssignmentGQL extends Apollo.Query<
...
export class UpdateLastUpdatedGQL extends Apollo.Mutation<
  UpdateLastUpdatedMutation,
  UpdateLastUpdatedMutationVariables
> {
  document = UpdateLastUpdatedDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
...
export class InsertAuditsGQL extends Apollo.Mutation<
  InsertAuditsMutation,
  InsertAuditsMutationVariables
> {
  document = InsertAuditsDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const InsertSuspectDocument = gql`
...
export class InsertSuspectGQL extends Apollo.Mutation<
  InsertSuspectMutation,
  InsertSuspectMutationVariables
> {
  document = InsertSuspectDocument;
  client = 'wmsNodejs';
  constructor(apollo: Apollo.Apollo) {
    super(apollo);
  }
}
export const InventoryUpdateDocument = gql`
...
export class InventoryUpdateGQL extends Apollo.Mutation<
...
export class DeleteAuditGQL extends Apollo.Mutation<
  DeleteAuditMutation,
...
export const CloseAuditDocument = gql`
...
export class CloseAuditGQL extends Apollo.Mutation<
  CloseAuditMutation,
  CloseAuditMutationVariables
> {
...
export class CloseAuditsGQL extends Apollo.Mutation<
  CloseAuditsMutation,
  CloseAuditsMutationVariables
> {
...
export class ClearTimeoutAuditsGQL extends Apollo.Mutation<
  ClearTimeoutAuditsMutation,
  ClearTimeoutAuditsMutationVariables
> {
...
export class UpdateSystemTriggerGQL extends Apollo.Mutation<
  UpdateSystemTriggerMutation,
  UpdateSystemTriggerMutationVariables
> {
...
export class InsertSystemTriggerGQL extends Apollo.Mutation<
  InsertSystemTriggerMutation,
  InsertSystemTriggerMutationVariables
> {
