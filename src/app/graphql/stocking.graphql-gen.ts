...
export type FindorCreateUserContainerForStockingMutationVariables =
  Types.Exact<{
    Barcode: Types.Scalars['String'];
    DistributionCenter: Types.Scalars['String'];
...
export type FindorCreateUserContainerForStockingMutation = {
  __typename?: 'Mutation';
...
export class FindorCreateUserContainerForStockingGQL extends Apollo.Mutation<
  FindorCreateUserContainerForStockingMutation,
  FindorCreateUserContainerForStockingMutationVariables
> {
