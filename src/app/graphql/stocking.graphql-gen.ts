...
export type VerifyItnForSortingQuery = { __typename?: 'Query', findInventory?: Array<{ __typename?: 'Inventory', QuantityOnHand: number, Product: { __typename?: 'Product', ProductCode: string, PartNumber: string } } | null> | null };
