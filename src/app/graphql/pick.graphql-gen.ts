...
export type FindNextItnForPullingQueryVariables = Types.Exact<{
  Zone: Types.Scalars['Int']['input'];
  StrictPriority: Types.Scalars['Boolean']['input'];
  PriorityCutoff: Types.Scalars['Int']['input'];
...
export type UpdateAfterPullingMutationVariables = Types.Exact<{
  ...
  InventoryID: Types.Scalars['Int']['input'];
  log:
...
export type UpdatePickingCalendarSettingsMutationVariables = Types.Exact<{
  events?: Types.InputMaybe<Types.Scalars['String']['input']>;
}>;
